...
CREATE TABLE IF NOT EXISTS `mydb`.`constructora` (
  ...
  CONSTRAINT `fk_constructora_identificacion1`
    ...
    REFERENCES `mydb`.`identificacion` (`ide_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `mydb`.`material_construccion` (
  ...
  PRIMARY KEY (`mat_id`),
  UNIQUE INDEX `mat_id_UNIQUE` (`mat_id` ASC) VISIBLE)
ENGINE = InnoDB;
...
-- Table `mydb`.`recibido`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`recibido` (
  `rec_id` INT NOT NULL,
  ...
  PRIMARY KEY (`rec_id`),
  INDEX `fk_recibido_material_construccion1_idx` (`rec_mat_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`trabajador` (
  ...
  INDEX `fk_trabajador_identificacion1_idx` (`tra_identificacion_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`proyecto` (
  ...
  CONSTRAINT `fk_proyecto_recibido1`
    ...
    REFERENCES `mydb`.`recibido` (`rec_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_proyecto_trabajador1`
    FOREIGN KEY (`pro_trabajador_id`)
    REFERENCES `mydb`.`trabajador` (`tra_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `mydb`.`utilizado`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`utilizado` (
  `uti_id` INT NOT NULL,
  ...
  PRIMARY KEY (`uti_id`),
  UNIQUE INDEX `uti_id_UNIQUE` (`uti_id` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`stock` (
  ...
  PRIMARY KEY (`sto_id`),
  UNIQUE INDEX `sto_id_UNIQUE` (`sto_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_stock_utilizado1`
    ...
    REFERENCES `mydb`.`utilizado` (`uti_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`usuario_s_roles`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`usuario_s_roles` (
  `rol_rol_id_rol` INT NOT NULL,
  `usuario_s_usuId` INT NOT NULL,
  INDEX `fk_usuario_s_roles_rol1_idx` (`rol_rol_id_rol` ASC) VISIBLE,
  INDEX `fk_usuario_s_roles_usuario_s1_idx` (`usuario_s_usuId` ASC) VISIBLE,
