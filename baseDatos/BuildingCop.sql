...
-- Schema id17639196_proyecto
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `id17639196_proyecto` DEFAULT CHARACTER SET utf8 ;

-- -----------------------------------------------------
-- Table `id17639196_proyecto`.`rol`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `id17639196_proyecto`.`rol` (
...
CREATE TABLE IF NOT EXISTS `id17639196_proyecto`.`constructora` (
  ...
  CONSTRAINT `fk_constructora_identificacion1`
    ...
    REFERENCES `id17639196_proyecto`.`identificacion` (`ide_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_constructora_usuario_s1`
    FOREIGN KEY (`usuario_s_usuId`)
    REFERENCES `id17639196_proyecto`.`usuario_s` (`usuId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `id17639196_proyecto`.`ubicacion`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `id17639196_proyecto`.`ubicacion` (
...
-- -----------------------------------------------------
-- Table `id17639196_proyecto`.`sede`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `id17639196_proyecto`.`sede` (
  ...
  CONSTRAINT `fk_sede_constructora1`
    ...
    REFERENCES `id17639196_proyecto`.`constructora` (`con_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_sede_ubicacion1`
    FOREIGN KEY (`sede_ubicacion_id`)
    REFERENCES `id17639196_proyecto`.`ubicacion` (`ubi_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `id17639196_proyecto`.`material_construccion`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `id17639196_proyecto`.`material_construccion` (
...
-- -----------------------------------------------------
-- Table `id17639196_proyecto`.`recibido`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `id17639196_proyecto`.`recibido` (
  ...
  CONSTRAINT `fk_recibido_material_construccion1`
    ...
    REFERENCES `id17639196_proyecto`.`material_construccion` (`mat_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `id17639196_proyecto`.`trabajador`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `id17639196_proyecto`.`trabajador` (
  ...
  CONSTRAINT `fk_trabajador_sede1`
    ...
    REFERENCES `id17639196_proyecto`.`sede` (`sede_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `id17639196_proyecto`.`id17639196_proyecto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `id17639196_proyecto`.`proyecto` (
  `pro_id` INT NOT NULL AUTO_INCREMENT,
  `material_construccion_mat_id` INT NULL,
  `pro_tipo_id17639196_proyecto` VARCHAR(50) NULL,
  `pro_nombre_id17639196_proyecto` VARCHAR(50) NULL,
  `pro_numero_id17639196_proyecto` INT NULL,
  `pro_descripcion_id17639196_proyecto` VARCHAR(100) NULL,
  ...
  PRIMARY KEY (`pro_id`),
  INDEX `fk_id17639196_proyecto_sede1_idx` (`pro_sede_id` ASC),
  INDEX `fk_id17639196_proyecto_recibido1_idx` (`pro_recibido_id` ASC),
  INDEX `fk_id17639196_proyecto_trabajador1_idx` (`pro_trabajador_id` ASC),
  INDEX `fk_id17639196_proyecto_material_construccion1_idx` (`material_construccion_mat_id` ASC),
  CONSTRAINT `fk_id17639196_proyecto_sede1`
    FOREIGN KEY (`pro_sede_id`)
    REFERENCES `id17639196_proyecto`.`sede` (`sede_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_id17639196_proyecto_recibido1`
    FOREIGN KEY (`pro_recibido_id`)
    REFERENCES `id17639196_proyecto`.`recibido` (`rec_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_id17639196_proyecto_trabajador1`
    FOREIGN KEY (`pro_trabajador_id`)
    REFERENCES `id17639196_proyecto`.`trabajador` (`tra_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_id17639196_proyecto_material_construccion1`
...
-- -----------------------------------------------------
-- Table `id17639196_id17639196_proyecto`.`utilizado`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `id17639196_proyecto`.`utilizado` (
...
-- -----------------------------------------------------
-- Table `id17639196_proyecto`.`stock`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `id17639196_proyecto`.`stock` (
  ...
  CONSTRAINT `fk_stock_utilizado1`
    ...
    REFERENCES `id17639196_proyecto`.`utilizado` (`uti_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `id17639196_proyecto`.`registro`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `id17639196_proyecto`.`registro` (
  ...
  CONSTRAINT `fk_registro_stock1`
    ...
    REFERENCES `id17639196_proyecto`.`stock` (`sto_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `id17639196_proyecto`.`usuario_s_roles`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `id17639196_proyecto`.`usuario_s_roles` (
  ...
  CONSTRAINT `fk_usuario_s_roles_rol1`
    ...
    REFERENCES `id17639196_proyecto`.`rol` (`rol_id_rol`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
