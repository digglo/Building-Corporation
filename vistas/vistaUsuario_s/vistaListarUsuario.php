        ...
        <tbody>
            ...
            foreach ($listaDeUsuarios as $key => $value) {
                ...
                <tr>
                    ...
                    <!--<td>d>-->   
                    <td><a href="Controlador.php?ruta=mostrarActualizarUsuario&idAct=<?php echo $listaDeUsuarios[$i]->usuId; ?>">Actualizar</a></td>  
                    <td><a href="Controlador.php?ruta=eliminarUsuario&idAct=<?php echo $listaDeUsuarios[$i]->usuId; ?>" onclick="return confirm('Está seguro de eliminar el registro?')">Eliminar</a></td>  
                </tr>   
                <?php
                $i++;
            }
