        ...
        <tbody>
            ...
            foreach ( $listaUbicacion as $key => $value) {
                ...
                <tr>
                    ...
                    <td><a href="Controlador.php?ruta=eliminarUbicacion&idAct=<?php echo $listaUbicacion[$i]->ubi_id; ?>" onclick="return confirm('Está seguro de eliminar el registro?')">Eliminar</a></td>  
                </tr>   
                <?php
                $i++;
            }
