        ...
        <tbody>
            ...
            foreach ($listaDeUbicacion as $key => $value) {
                ...
                <tr> 
                    ...
                    <!--<td>d>--> 
                    <td><a href="Controlador.php?ruta=mostrarActualizarUbicacion&ubi_id=<?php echo $listaDeUbicacion[$i]->ubi_id; ?>">Actualizar</a></td>  
                    <td><a href="Controlador.php?ruta=eliminarUbicacion&ubi_id=<?php echo $listaDeUbicacion[$i]->ubi_id; ?>" onclick="return confirm('Está seguro de eliminar el registro?')">Eliminar</a></td>  
                </tr>   
                <?php
                $i++;
            }
