        ...
        <form role="form" action="Controlador.php" method="POST" id="formVehiculos" >
            <table>
                ...
                <tr>
                    ...
                    <td>
                            <input type="form-control" type="text" name="pro_numero_proyecto" placeholder="Numero Proyecto" size="50" 
                    ...
                    <td>
                            <select name="pro_recibido_id" id="pro_recibido_id" style="width: 338px">
                                ...
                                ?>
                                    ...
                                    <?php echo  $listaDeRecibido[$i]->rec_id.' - '. $listaDeRecibido[$i] ->rec_cantidad_recibido; ?></option>
                                <?php
                                }
                                ?>
                            </select>
