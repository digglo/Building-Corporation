        ...
        <tbody>
            ...
            foreach ($listaDeProyecto as $key => $value) {
                ...
                <tr>
                    ...
                    <td><a href="Controlador.php?ruta=habilitarProyecto&idAct=<?php echo $listaDeProyecto[$i]->pro_id; ?>" onclick="return confirm('Está seguro de habilitar el registro?')">Habilitar</a></td>  
                </tr>   
                <?php
                $i++;
            }
